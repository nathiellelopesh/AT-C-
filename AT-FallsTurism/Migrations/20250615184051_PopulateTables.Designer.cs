...
namespace AT_FallsTurism.Migrations
{
    ...
    [Migration("20250615184051_PopulateTables")]
            ...
            modelBuilder.Entity("AT_FallsTurism.Models.Reserva", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClienteId = 1,
                            DataReserva = new DateTime(2025, 6, 5, 15, 40, 50, 794, DateTimeKind.Local).AddTicks(5854),
                            PacoteTuristicoId = 1
                        },
                        new
                        {
                            Id = 2,
                            ClienteId = 2,
                            DataReserva = new DateTime(2025, 6, 10, 15, 40, 50, 800, DateTimeKind.Local).AddTicks(5355),
                            PacoteTuristicoId = 2
                        });
                });
